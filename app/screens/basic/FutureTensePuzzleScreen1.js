...
export default function FutureTensePuzzleScreen1({ navigation, route }) {
  const { 
    image = require("../../../assets/items/girl-reading.png"),
    correctSentence = "She will read a book", 
    words = ["She", "He", "reads", "will read", "a", "an", "book", "newspaper"]
  } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate('FutureTensePuzzleScreen2');
  };
...
// Reuse the exact same styles from your PastTensePuzzleScreen
