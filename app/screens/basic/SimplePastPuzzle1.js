...
export default function SimplePastPuzzle1({ navigation, route }) {
  const { 
    image = require("../../../assets/items/boy-drinking.png"),
    correctSentence = "He drank water", 
    words = ["He", "She", "drank", "drink", "tea", "water"]
  } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate('SimplePastPuzzle2');
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Past Tense Puzzle</Text>
