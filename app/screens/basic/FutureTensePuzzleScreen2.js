...
export default function FutureTensePuzzleScreen2({ navigation, route }) {
  const { 
    image = require("../../../assets/items/boy-drinking.png"),
    correctSentence = "He will drink water", 
    words = ["He", "She", "will", "drink", "drank", "water", "going to"]
  } = route?.params || {};
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate('FutureTensePuzzle2');
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Future Tense Puzzle</Text>
        ...
        <View style={styles.mainContent}>
          ...
          <View style={[styles.imageContainer, { width: imageSize, height: imageSize }]}>
            <Image 
              source={typeof image === 'number' ? image : require("../../../assets/items/boy-drinking.png")} 
