...
export default function PastTensePuzzleScreen3({ navigation, route }) {
  const { 
    image = require("../../../assets/items/boy-playing.png"),
    correctSentence = "He played soccer yesterday", 
    words = ["He", "They", "plays", "played", "play", "soccer", "basketball", "yesterday", "every", "day"]
  } = route?.params || {};
  ...
  const checkAnswer = () => {
    ...
    const submittedSentence = placedWords.map(wordObj => wordObj.word).join(' ');
  ...
  const moveToNextPuzzle = () => {
    navigation.navigate('PastTensePuzzleScreen');
  };
          ...
          <View style={styles.feedbackContainer}>
            ...
            <View style={styles.actionButtonsContainer}>
              <TouchableOpacity 
                ...
                activeOpacity={0.7}
              >
                <FontAwesome5 name="arrow-circle-right" size={22} color="white" />
              ...
              {!isCorrect && (
                <TouchableOpacity 
                  ...
                  activeOpacity={0.7}
                >
                  <FontAwesome5 name="redo-alt" size={22} color="white" />
