...
export default function ZPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'ZEBRA', image: require('../../../../assets/items/zebra.png') },
    { id: 2, name: 'ZOO', image: require('../../../../assets/items/zoo.png') },
    { id: 3, name: 'ZIPPER', image: require('../../../../assets/items/zipper.png') },
    { id: 4, name: 'ZERO', image: require('../../../../assets/items/zero.png') },
    { id: 5, name: 'ZINC', image: require('../../../../assets/items/zinc.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('zPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Z Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenZ${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
