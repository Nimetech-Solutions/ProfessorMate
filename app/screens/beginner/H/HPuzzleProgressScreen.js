...
export default function HPuzzleProgressScreen({ navigation }) {
  ...
  // H letter puzzles data
  const puzzles = [
    { id: 1, name: 'HAT', image: require('../../../../assets/items/hat.png') },
    { id: 2, name: 'HOUSE', image: require('../../../../assets/items/house.png') },
    { id: 3, name: 'HORSE', image: require('../../../../assets/items/horse.png') },
    { id: 4, name: 'HAND', image: require('../../../../assets/items/hand.png') },
    { id: 5, name: 'HEART', image: require('../../../../assets/items/heart.png') },
  ];
  ...
  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('hPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>H Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenH${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
