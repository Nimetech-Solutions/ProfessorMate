...
export default function SPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'SUN', image: require('../../../../assets/items/sun.png') },
    { id: 2, name: 'STAR', image: require('../../../../assets/items/star.png') },
    { id: 3, name: 'SNAKE', image: require('../../../../assets/items/snake.png') },
    { id: 4, name: 'STRAWBERRY', image: require('../../../../assets/items/strawberry.png') },
    { id: 5, name: 'SHEEP', image: require('../../../../assets/items/sheep.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('sPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>S Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenS${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
