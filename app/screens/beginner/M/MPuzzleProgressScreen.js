...
export default function MPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'MOON', image: require('../../../../assets/items/moon.png') },
    { id: 2, name: 'MONKEY', image: require('../../../../assets/items/monkey.png') },
    { id: 3, name: 'MOUSE', image: require('../../../../assets/items/mouse.png') },
    { id: 4, name: 'MANGO', image: require('../../../../assets/items/mango.png') },
    { id: 5, name: 'MAP', image: require('../../../../assets/items/map.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('mPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>M Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenM${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
