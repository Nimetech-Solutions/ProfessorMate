...
export default function YPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'YACHT', image: require('../../../../assets/items/yacht.png') },
    { id: 2, name: 'YAK', image: require('../../../../assets/items/yak.png') },
    { id: 3, name: 'YARN', image: require('../../../../assets/items/yarn.png') },
    { id: 4, name: 'YOGURT', image: require('../../../../assets/items/yogurt.png') },
    { id: 5, name: 'YOYO', image: require('../../../../assets/items/yoyo.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('yPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Y Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenY${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
