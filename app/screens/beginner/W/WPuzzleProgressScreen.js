...
export default function WPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'WATER', image: require('../../../../assets/items/water.png') },
    { id: 2, name: 'WINDOW', image: require('../../../../assets/items/window.png') },
    { id: 3, name: 'WATCH', image: require('../../../../assets/items/watch.png') },
    { id: 4, name: 'WHALE', image: require('../../../../assets/items/whale.png') },
    { id: 5, name: 'WAGON', image: require('../../../../assets/items/wagon.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('wPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>W Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenW${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
