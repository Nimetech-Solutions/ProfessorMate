...
export default function GPuzzleProgressScreen({ navigation }) {
  ...
  // G letter puzzles data
  const puzzles = [
    { id: 1, name: 'GOAT', image: require('../../../../assets/items/goat.png') },
    { id: 2, name: 'GIRAFFE', image: require('../../../../assets/items/giraffe.png') },
    { id: 3, name: 'GRAPES', image: require('../../../../assets/items/grapes.png') },
    { id: 4, name: 'GUITAR', image: require('../../../../assets/items/guitar.png') },
    { id: 5, name: 'GIFT', image: require('../../../../assets/items/gift.png') },
  ];
  ...
  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('gPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>G Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenG${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
