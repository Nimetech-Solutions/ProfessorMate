...
export default function RPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'RABBIT', image: require('../../../../assets/items/rabbit.png') },
    { id: 2, name: 'RAINBOW', image: require('../../../../assets/items/rainbow.png') },
    { id: 3, name: 'ROCKET', image: require('../../../../assets/items/rocket.png') },
    { id: 4, name: 'ROBOT', image: require('../../../../assets/items/robot.png') },
    { id: 5, name: 'ROSE', image: require('../../../../assets/items/rose.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('rPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>R Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenR${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
