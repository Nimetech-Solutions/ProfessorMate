...
export default function QPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'QUILT', image: require('../../../../assets/items/quilt.png') },
    { id: 2, name: 'QUIET', image: require('../../../../assets/items/quiet.png') },
    { id: 3, name: 'QUAIL', image: require('../../../../assets/items/quail.png') },
    { id: 4, name: 'QUEEN', image: require('../../../../assets/items/queen.png') },
    { id: 5, name: 'QUINCE', image: require('../../../../assets/items/quince.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('qPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Q Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenQ${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
