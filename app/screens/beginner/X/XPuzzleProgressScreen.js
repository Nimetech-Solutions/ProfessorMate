...
export default function XPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'XYLOPHONE', image: require('../../../../assets/items/xylophone.png') },
    { id: 2, name: 'XRAY', image: require('../../../../assets/items/xray.png') },
    { id: 3, name: 'XERUS', image: require('../../../../assets/items/xerus.png') },
    { id: 4, name: 'XEROX', image: require('../../../../assets/items/xerox.png') },
    { id: 5, name: 'XBOX', image: require('../../../../assets/items/xbox.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('xPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>X Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenX${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
