...
export default function EPuzzleProgressScreen({ navigation }) {
  ...
  // E letter puzzles data
  const puzzles = [
    { id: 1, name: 'EAGLE', image: require('../../../../assets/items/egg.png') },
    { id: 2, name: 'ELEPHANT', image: require('../../../../assets/items/elephant.png') },
    { id: 3, name: 'EYE', image: require('../../../../assets/items/eye.png') },
    { id: 4, name: 'EAR', image: require('../../../../assets/items/ear.png') },
    { id: 5, name: 'EARTH', image: require('../../../../assets/items/earth.png') },
  ];
  ...
  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('ePuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>E Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenE${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
