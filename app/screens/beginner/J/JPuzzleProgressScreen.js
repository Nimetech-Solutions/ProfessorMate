...
export default function JPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'JACKET', image: require('../../../../assets/items/jacket.png') },
    { id: 2, name: 'JAR', image: require('../../../../assets/items/jar.png') },
    { id: 3, name: 'JELLY', image: require('../../../../assets/items/jelly.png') },
    { id: 4, name: 'JUICE', image: require('../../../../assets/items/juice.png') },
    { id: 5, name: 'JUMP', image: require('../../../../assets/items/jaguar.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('jPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>J Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenJ${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
