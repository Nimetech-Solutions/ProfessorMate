...
export default function OPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'ORANGE', image: require('../../../../assets/items/orange.png') },
    { id: 2, name: 'OWL', image: require('../../../../assets/items/owl.png') },
    { id: 3, name: 'OCTOPUS', image: require('../../../../assets/items/octopus.png') },
    { id: 4, name: 'ONION', image: require('../../../../assets/items/onion.png') },
    { id: 5, name: 'OIL', image: require('../../../../assets/items/oil.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('oPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>O Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenO${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
