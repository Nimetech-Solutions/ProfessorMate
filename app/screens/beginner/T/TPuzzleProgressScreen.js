...
export default function TPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'TABLE', image: require('../../../../assets/items/table.png') },
    { id: 2, name: 'TIGER', image: require('../../../../assets/items/tiger.png') },
    { id: 3, name: 'TREE', image: require('../../../../assets/items/tree.png') },
    { id: 4, name: 'TRAIN', image: require('../../../../assets/items/train.png') },
    { id: 5, name: 'TURTLE', image: require('../../../../assets/items/turtle.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('tPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>T Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenT${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
