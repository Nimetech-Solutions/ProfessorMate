...
export default function IPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'ICE', image: require('../../../../assets/items/ice.png') },
    { id: 2, name: 'IGLOO', image: require('../../../../assets/items/igloo.png') },
    { id: 3, name: 'INSECT', image: require('../../../../assets/items/insect.png') },
    { id: 4, name: 'IRON', image: require('../../../../assets/items/iron.png') },
    { id: 5, name: 'ISLAND', image: require('../../../../assets/items/island.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('iPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>I Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenI${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
