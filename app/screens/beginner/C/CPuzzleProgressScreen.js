...
export default function CPuzzleProgressScreen({ navigation }) {
  ...
  // C letter puzzles data
  const puzzles = [
    { id: 1, name: 'CAT', image: require('../../../../assets/items/cat.png') },
    { id: 2, name: 'CAR', image: require('../../../../assets/items/car.png') },
    { id: 3, name: 'CAKE', image: require('../../../../assets/items/cake.png') },
    { id: 4, name: 'COW', image: require('../../../../assets/items/cow.png') },
    { id: 5, name: 'CUP', image: require('../../../../assets/items/cup.png') },
  ];
  ...
  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('cPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>C Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenC${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
