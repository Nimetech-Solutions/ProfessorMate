...
export default function PPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'PENCIL', image: require('../../../../assets/items/pencil.png') },
    { id: 2, name: 'PENGUIN', image: require('../../../../assets/items/penguin.png') },
    { id: 3, name: 'PUMPKIN', image: require('../../../../assets/items/pumpkin.png') },
    { id: 4, name: 'PARROT', image: require('../../../../assets/items/parrot.png') },
    { id: 5, name: 'PANDA', image: require('../../../../assets/items/panda2.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('pPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>P Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenP${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
