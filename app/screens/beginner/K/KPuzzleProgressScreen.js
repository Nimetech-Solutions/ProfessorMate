...
export default function KPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'KEY', image: require('../../../../assets/items/key.png') },
    { id: 2, name: 'KITE', image: require('../../../../assets/items/kite.png') },
    { id: 3, name: 'KING', image: require('../../../../assets/items/king.png') },
    { id: 4, name: 'KANGAROO', image: require('../../../../assets/items/kangaroo.png') },
    { id: 5, name: 'KITCHEN', image: require('../../../../assets/items/kitchen.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('kPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>K Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenK${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
