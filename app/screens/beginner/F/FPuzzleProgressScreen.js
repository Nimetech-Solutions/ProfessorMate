...
export default function FPuzzleProgressScreen({ navigation }) {
  ...
  // F letter puzzles data
  const puzzles = [
    { id: 1, name: 'FISH', image: require('../../../../assets/items/fish.png') },
    { id: 2, name: 'FLOWER', image: require('../../../../assets/items/flower.png') },
    { id: 3, name: 'FROG', image: require('../../../../assets/items/frog.png') },
    { id: 4, name: 'FOX', image: require('../../../../assets/items/fox.png') },
    { id: 5, name: 'FLAG', image: require('../../../../assets/items/flag.png') },
  ];
  ...
  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('fPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>F Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenF${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
