...
export default function NPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'NEST', image: require('../../../../assets/items/nest.png') },
    { id: 2, name: 'NOSE', image: require('../../../../assets/items/nose.png') },
    { id: 3, name: 'NAIL', image: require('../../../../assets/items/nail.png') },
    { id: 4, name: 'NET', image: require('../../../../assets/items/net.png') },
    { id: 5, name: 'NURSE', image: require('../../../../assets/items/nurse.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('nPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>N Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenN${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
