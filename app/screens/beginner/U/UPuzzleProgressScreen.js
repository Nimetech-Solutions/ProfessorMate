...
export default function UPuzzleProgressScreen({ navigation }) {
  ...
  const puzzles = [
    { id: 1, name: 'UMBRELLA', image: require('../../../../assets/items/umbrella.png') },
    { id: 2, name: 'UNICORN', image: require('../../../../assets/items/unicorn.png') },
    { id: 3, name: 'UNIFORM', image: require('../../../../assets/items/uniform.png') },
    { id: 4, name: 'UNIVERSE', image: require('../../../../assets/items/universe.png') },
    { id: 5, name: 'UKULELE', image: require('../../../../assets/items/ukulele.png') },
  ];

  useEffect(() => {
    const loadPuzzleStatus = async () => {
      try {
        const storedStatus = await AsyncStorage.getItem('uPuzzleStatus');
        if (storedStatus) {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>U Words Progress</Text>
          ...
          <View style={styles.puzzlesGrid}>
            {puzzles.map((puzzle) => (
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate(`WordPuzzleScreenU${puzzle.id}`, {
                  word: puzzle.name,
                  image: puzzle.image
                })}
              >
